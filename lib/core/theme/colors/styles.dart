...
abstract class AppColors {
  ...
  //barq
  static const Color kPrimary600 = Color(0xff5F2EA9);

  //barq
  static const Color kPrimary800 = Color.fromRGBO(27, 13, 49, 0.8);
  //barq
  static const Color kSecondary500 = Color.fromRGBO(234, 204, 24, 1);
  //barq
  static const Color lightBlue = Color(0xFFCFF0FF);

  //barq
  static const Color kOpacityPrimary = Color(0xffD0BDED);
  //mazadat
  static const Color kGeryText = Color(0xff747474);
  //mazadat
  static const Color kGeryText2 = Color.fromRGBO(185, 185, 185, 1);
  //mazadat
  static const Color kGeryText3 = Color.fromRGBO(162, 162, 162, 1);
  //mazadat
  static const Color kGeryText4 = Color.fromRGBO(116, 116, 116, 1);
  //mazadat
  static const Color kGeryText5 = Color.fromRGBO(140, 140, 140, 1);
  //mazadat
  static const Color kGeryText6 = Color.fromRGBO(139, 139, 139, 1);
  //mazadat
  static const Color kGeryText7 = Color.fromRGBO(116, 116, 116, 1);
  //mazadat
  static const Color kGeryText8 = Color.fromRGBO(232, 232, 232, 1);
  //mazadat
  static const Color kGeryText9 = Color.fromRGBO(117, 117, 117, 1);
  //mazadat
  static const Color kGeryText10 = Color.fromRGBO(242, 242, 242, 1);

  //mazadat
  static const Color kOpacityGrey = Color.fromRGBO(245, 247, 248, 1);
  //mazadat
  static const Color kOpacityGrey2 = Color.fromRGBO(237, 241, 243, 1);
  //mazadat
  ...
  //barq
  static const Color kGold = Color.fromRGBO(235, 202, 3, 1);
  static const Color kGold2 = Color.fromRGBO(234, 204, 24, 1);
  static const Color kGold3 = Color.fromRGBO(223, 180, 0, 1);

  //barq
  static const Color Kburgundy = Color.fromRGBO(111, 28, 30, 1);
  //barq
  static const Color navyBlue = Color.fromRGBO(24, 98, 132, 1);
  //barq
  static const Color Kbrown = Color.fromRGBO(82, 61, 17, 1);
  //barq
  static const Color KGreen = Color.fromRGBO(28, 157, 89, 1);
  //barq
  static const Color KRed200 = Color(0xFFD00416);
