...
class BundlePaymentStatusWidget extends StatelessWidget {
  const BundlePaymentStatusWidget({
    super.key,
      ...
      child: Column(
        ...
        children: [
          ...
          DefaultButton(
            ...
            text: isPaymentSuccess ? 'العودة للمزاد' : 'تغيير طريقة الدفع',
