...
import 'change_password_success_button_widget.dart';

part '../pages/change_password_success_screen.dart';
part '../pages/change_password_success_screen_mobile_design.dart';
