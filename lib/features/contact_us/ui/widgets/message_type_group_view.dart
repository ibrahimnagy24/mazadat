...
class MessageTypeGroupView extends StatefulWidget {
  const MessageTypeGroupView({
    super.key,
    required this.data,
    this.initialValue,
    this.onSelect,
  ...
  final List<MessageTypeEntity> data;
  final int? initialValue;
  final Function(MessageTypeEntity)? onSelect;
  final BuildContext modalContext;

  @override
  State<MessageTypeGroupView> createState() => _MessageTypeGroupViewState();
}

class _MessageTypeGroupViewState extends State<MessageTypeGroupView> {
  int? _selectedItem;
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  MainText(
                    text: AppStrings.selectMessageType.tr,
