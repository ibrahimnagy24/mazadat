// Removed preview_auction specific enums - using basic types instead
...
class AuctionDetailsModel {
  ...
  AuctionDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    auctionType = json['auctionType'] != null
        ? json['auctionType']['code']?.toString() ?? 'public'
        : 'public';
    ...
    currentBiddingMethod = json['currentBiddingMethod']?.toString();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (auctionType != null) {
      data['auctionType'] = auctionType?.toUpperCase();
    }
    ...
    if (currentBiddingMethod != null) {
      data['currentBiddingMethod'] = currentBiddingMethod?.toUpperCase();
    }
    return data;
  }
}
